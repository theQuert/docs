...
<Frame caption="Azure (intended): LangSmith and Engine run in your environment; LSI and Foundry run in LangChain's Azure environment.">
  <img
    ...
    alt="Architecture diagram showing a self-hosted LangSmith deployment in your Azure environment connecting to LangSmith Intelligence in LangChain's cloud, which sends model inference requests to Foundry"
  />
</Frame>
