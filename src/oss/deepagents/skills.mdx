...
In Deep Agents, @[`SkillsMiddleware`] (part of the [Deep Agents stack](/oss/deepagents/customization#deep-agents-stack) when you pass `skills`) handles the first two levels, with the third level being handled by the LLM:
