...
| ------- | --------- | ----------- | ----------- |
| Short-term memory | [Short-term memory](/oss/langgraph/add-memory#add-short-term-memory) | [Short-term memory](/oss/langchain/short-term-memory) | [`StateBackend`](/oss/deepagents/backends#statebackend) |
| Long-term memory | [Long-term memory](/oss/langgraph/add-memory#add-long-term-memory) | [Long-term memory](/oss/langchain/long-term-memory) | [Long-term memory](/oss/deepagents/memory) |
